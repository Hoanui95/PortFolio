...
class Balle(ShowBase):
    ...
    def __init__(self, identifiantLanceur,mondePhysique, nom, dto):
    ...
    def exploser(self):
        if(self.etat == "actif"):
            ...
            #VARIABLE
            #Grosseur
            grosseurScaleFinal =  self.dto.size_explode_ball[2]
    ...
    def projetter(self, position, direction):
        ...
        #Canon
        #VARIABLE
        vitesseBalle =  self.dto.canon_speed_ball[2]
    ...
    def projetterRapide(self, position, direction):
        ...
        #Mitraillette
        #VARIABLE
        vitesseBalle =  self.dto.mitrail_speed_ball[2]
        self.noeudPhysique.node().applyCentralImpulse(direction * vitesseBalle)
        self.mondePhysique.attachRigidBody(self.noeudPhysique.node())
        #Tmeps
    ...
    def projetterVariable(self, position, direction):
        ...
        #VARIABLE
        #Shotgun
        vitesseBalle =  self.dto.shotgun_speed_ball[2]
        self.noeudPhysique.node().applyCentralImpulse(direction * vitesseBalle)
        self.mondePhysique.attachRigidBody(self.noeudPhysique.node())
    ...
    def deposer(self, position, direction):
        ...
        #VARIABLE
        #Piege
        vitesseBalle =  self.dto.piege_speed_ball[2]
        self.noeudPhysique.node().applyCentralImpulse(direction * vitesseBalle)
        self.mondePhysique.attachRigidBody(self.noeudPhysique.node())
        #Temps
    ...
    def lancer(self, position, direction):
        ...
        # elle est passé directement en paramètre 
        self.vitesseInitialeBalle=self.dto.grenade_speed_init_ball[2]
        ...
        self.noeudPhysique.node().setLinearVelocity(directionFinale * self.vitesseInitialeBalle)
        self.mondePhysique.attachRigidBody(self.noeudPhysique.node())
        #Temps
    ...
    def lancerGuide(self, position, noeudCible):
        ...
        self.lancer(position, Vec3(0,0,1))
    ...
    def lancerSurCible(self,noeudCible):
        ...
        #VARIABLE 
        #Guide ??
        vitesseInitialeBalle = self.dto.missile_speed_ball[2]
